...
$$
\frac{DAU\times 0.95 \times \text{кол-во просмотренных трансляций в день} }{86400} = \frac{31 \times 10^{6}\times 0.95\times  3}{86400} \approx 1023\ \text{RPS}
$$
...
Для подсчета RPS по подпискам также не достаточно информации в открытых источниках, поэтому исходя из [открытых данных]() о количестве подписчиков
