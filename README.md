...
- [Проект по курсу "Проектирование высоконагруженных систем".](#проект-по-курсу-проектирование-высоконагруженных-систем)
  ...
  - [3.  Глобальная балансировка нагрузки](#3-глобальная-балансировка-нагрузки)
    - [3.1 Использование CDN](#31-использование-cdn)
    - [3.2 Физическое расположение датацентров](#32-физическое-расположение-датацентров)
    ...
    - [3.3 Нагрузка на дата центры](#33-нагрузка-на-дата-центры)
    - [3.4 Схема DNS балансировки](#34-схема-dns-балансировки)
  - [4. Локальная балансировка нагрузки](#4-локальная-балансировка-нагрузки)
  - [5. Логическая схема БД](#5-логическая-схема-бд)
  - [6. Физическая схема](#6-физическая-схема)
  - [Источники](#источники)
<!--toc:end-->
...
В качестве CDN можно использовать Amazon CloudFront.
...
### 3.1 Использование CDN

Видеостримы особенно требуют низкой задержки. CDN может обеспечивать доставку видео в реальном времени с минимальными задержками. Кроме того, CDN  может использоваться как средство глобальной балансировки нагрузки, автоматически маршрутизируя пользователей к ближайшему узлу СDN.
