...
$$
\frac{31 \times 10^{6}\times 0.95\times  3}{86400} \approx 1023\ \text{RPS}
$$

Проведение трансляции, учитывая, что [количество активных стримеров за день составляет примерно 1 300 000 ](https://twitchtracker.com/statistics/active-streamers) трансляций
