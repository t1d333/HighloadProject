...
- Цюрих (центральной Европе)
- Париж (западной Европы)
...
В Австралии располагается всего 1.6% пользователей, а так же с учетом плотности населения можно расположить один ДЦ в однои из крупных городов, например в городе Сидней.
...
Для обеспечения высокой доступности и минимизации задержек будем использовать глобальный Latency Based DNS-балансировщик. Например, одним из популярных инструментов для этой цели является Amazon Route 53.
...
- 60% трафика в Сан-Паулу обеспечивает высокую доступность и быстрый доступ к контенту для бразильских пользователей и пользователей соседних стран.
- 40% трафика в Буэнос-Айрос обеспечивает обслуживание пользователей из Аргентины и других стран региона, таких как Уругвай и Парагвай.

#### Австралия

- Сидней — 100%
  **Обоснование:** Австралия имеет только один региональный дата-центр в Сиднее, поэтому все запросы из этого региона направляются туда.
