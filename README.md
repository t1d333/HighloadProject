...
| Nginx        | L7 балансировщик, reverse proxy   | Активное сообщество, наличие модулей для поддержки RTMP и HLS                              |
...
| Tarantool    | Хранение чата активных трансляций | Высокая производительность, совместимость с golang                                         |
